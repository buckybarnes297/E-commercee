  ...
  render() {
    return (
      <div class="container-fluid">
        <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white me-2" style={{marginLeft: '40px', marginTop: '47px'}}><i class="mdi mdi-comment-plus-outline"></i></span>Add FAQ</h3>
        <div class="row">
              ...
              <div class="card-body">
                ...
                <form class="forms-sample">
                  ...
                  <button type="button" class="btn btn-gradient-primary me-2" style={{
                    backgroundColor: 'blue',
                    color: 'white' ,borderRadius:'2rem'
                  }} onClick={this.validation}>Cancel</button>
                </form>
              </div>
            </div>
          </div>
