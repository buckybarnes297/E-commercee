    ...
    render() {
        ...
        return (
            <>
                ...
                <div class="table">
        <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white me-2" style={{marginLeft: '52px', marginTop: '47px'}}><i class="mdi mdi-comment-plus-outline"></i></span>List FAQs</h3>
